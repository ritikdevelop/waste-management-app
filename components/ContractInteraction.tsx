      ...
      {proposalResult && (
        <div>
          ...
          {proposalResult.success ? (
            <p>
              Proposal submitted successfully. Transaction Hash:{" "}
              {proposalResult.txHash}
            </p>
          ) : (
            <p>
              Proposal needs more signatures. Current count:{" "}
              {proposalResult.sigCount}
            </p>
          )}
        </div>
      )}
